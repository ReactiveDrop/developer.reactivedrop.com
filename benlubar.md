...
(It is always okay to email someone if you have something to say to them.)
...
(Things that have definitive schedules.)

### FEBRUARY 1: HoIAF Season 20

We're planning some major changes to Heroes of the Interstellar Armed Forces scoring for February 2024. Over a hundred multiplier adjustments, the personal best system, and the mission bounties system are ready for launch. May make some UI adjustments, especially on the web interface, as needed.
...
If Valve decides AS:RD doesn't qualify for this fest, we will simply reuse the item ID for the next event we apply to.

## Upcoming

(Things that are not scheduled by calendar dates, roughly in the order I expect to work on them.)

### Player Reporting

### UI Technical Debt Reduction

### HoIAF Playground

### Spy Cards Online

This isn't AS:RD related, but for a long time I've been wanting to update the graphics and networking code for [Spy Cards Online](https://spy-cards.lubar.me/) to make it work better using what I've learned from working on AS:RD. Maybe I'll learn something that I can apply back to AS:RD!

### Crafting Material Beta

### Loadouts Screen

### VScript Computer Screens
